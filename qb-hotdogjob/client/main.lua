                ...
                if ClosestObject ~= nil and ClosestObject == StandObject then
                    ...
                    if ObjectDistance < 1.0 then
                        ...
                        if IsControlJustPressed(0, 38) then
                            QBCore.Functions.TriggerCallback('qb-hotdogjob:apple', function(hasItem)
                            if hasItem then                          
                                        local playerPed = PlayerPedId()
                                                QBCore.Functions.Progressbar("Готвене", "Приготвяш хотдог...", 1000, false, true, {
                                                ...
                                                TriggerServerEvent('qb-hotdogjob:server:addhotdog')
                                                    Wait(15000)
                                                        end, 
                                                    function() -- Cancel                                              
                                                end)
                            else
                            QBCore.Functions.Notify("Нямаш необходимите неща. Кренвирш и багета")                    
